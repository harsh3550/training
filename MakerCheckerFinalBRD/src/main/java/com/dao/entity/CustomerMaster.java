...
@Repository
@Entity
@Table(name = "CUSTOMER_MASTER_16895")
public class CustomerMaster {
    ...
    public CustomerMaster(Integer cid, String customerCode, String customerName, String
            address1, String address2, Integer pinCode, String email, String contactNumber,
    ...
    public CustomerMaster(String customerCode, String customerName, String address1, String address2,
                          Integer pinCode, String email, String contactNumber, String primaryContactPerson,
                          String recordStatus, String createDate, String createdBy, String modifiedDate,
                          String modifiedBy, String authorizedDate, String authorizedBy) {
        this.customerCode = customerCode;
        this.customerName = customerName;
        this.address1 = address1;
        this.address2 = address2;
